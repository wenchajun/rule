...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	$(CONTROLLER_GEN) $(CRD_OPTIONS) paths="./..." output:crd:artifacts:config=deploy/helm/v3/crds
	kustomize build config/crd | sed -e '/creationTimestamp/d' > deploy/yaml/crds.yaml
	kustomize build deploy/yaml  > deploy/yaml/bundle.yaml
